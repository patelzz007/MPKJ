        ...
        <div class="md:flex md:flex-col md:items-stretch md:opacity-100 md:relative md:mt-4 md:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-y-auto overflow-x-hidden h-auto items-center flex-1 rounded hidden" id="example-collapse-sidebar">
            ...
            <ul class="md:flex-col md:min-w-full flex flex-col list-none">
                ...
                @can('configuration_access')
                    <li class="items-center">
                        <a class="has-sub {{ request()->is("admin/configuration/bahagians*")||request()->is("admin/configuration/perkhidmatans*")||request()->is("admin/configuration/masa-temu-janjis*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="#" onclick="window.openSubNav(this)">
                        ...
                        <ul class="ml-4 subnav hidden">
                            @can('bahagian_access')
                                <li class="items-center">
                                    <a class="{{ request()->is("admin/configuration/bahagians*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.configuration.bahagians.index") }}">
                            ...
                            @can('perkhidmatan_access')
                                <li class="items-center">
                                    <a class="{{ request()->is("admin/configuration/perkhidmatans*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.configuration.perkhidmatans.index") }}">
                                        <i class="fa-fw c-sidebar-nav-icon fas fa-cogs">
                                        </i>
                            ...
                            @can('masa_temu_janji_access')
                                <li class="items-center">
                                    <a class="{{ request()->is("admin/configuration/masa-temu-janjis*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.configuration.masa-temu-janjis.index") }}">
                                        <i class="fa-fw c-sidebar-nav-icon fas fa-cogs">
                                        </i>
